  ...
  return (
    <div className="p-4 pb-32">
      ...
      <div className="space-y-4">
        {cart.map(item => (
          <div key={item.product.id} className="flex gap-4 bg-rio-surface p-3.5 rounded-2xl border border-rio-border shadow-sm">
            <div className="relative h-20 w-20 rounded-xl overflow-hidden bg-rio-surface-muted shrink-0">
              <img src={item.product.image} alt={item.product.name} className="object-cover h-full w-full mix-blend-multiply" />
            </div>
      ...
      <div className="mt-8 bg-rio-surface p-5 rounded-2xl border border-rio-border shadow-sm space-y-3">
      ...
      <div className="mt-8">
        ...
        <p className="mt-4 text-[11px] text-center text-rio-muted font-medium max-w-[280px] mx-auto">
